    ...
    <div class="modal">
      ...
      >
        <div class="modal__body">
          <div class="modal__title">Сменить пароль</div>

          <div class="modal__content modal__content_my-24">
            <Input
                type="password"
            ...
            <Input
                ...
                width="100%"
                :show-password="true"
                @custom-input="setPasswordConfirmation"
            />
          </div>
          <Button type="submit" name="Сменить пароль" width="100%" @click="changePassword"/>
...
export default {
  ...
  methods: {
    ...
    changePassword() {
      this.updatePassword(this.password).then(() => this.close(null))
    },
    ...
    setPasswordConfirmation(password) {
      this.password.password_confirmation = password
    },
    close(e) {
...
@import "@/assets/scss/modals/_changePasswordModal.scss";
