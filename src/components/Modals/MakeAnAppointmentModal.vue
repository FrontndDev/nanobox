  ...
  <Teleport to="body">
    ...
    >
      <div class="modal__body">
        ...
        <DoctorAppointmentForm @close-modal="close(null)"/>
...
<script>
import DoctorAppointmentForm from "@/components/Modals/MakeAnAppointment/DoctorAppointmentForm.vue";

export default {
  name: "MakeAnAppointmentModal",
  components: {DoctorAppointmentForm},
  data() {
    return {
      modal: {
        width: 0,
